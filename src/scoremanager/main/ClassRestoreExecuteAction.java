...
public class ClassRestoreExecuteAction extends Action {
    public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
        try {
            ...
            boolean result = dao.restore(classNum);

            if (result) {
                req.getRequestDispatcher("class_restore_done.jsp").forward(req, res);
            } else {
                req.setAttribute("message", "該当クラスが存在しないか、復元できませんでした。");
