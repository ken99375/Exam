...
<c:import url="/common/base.jsp">
    ...
    <c:param name="content">
        <section class="me-4">
            <h2 class="h3 mb-3 fw-normal bg-secondary bg-opacity-10 py-2 px-4">成績一覧（${item}）</h2>
		...
		<c:choose>
		    ...
		    <c:when test = "${empty sub_li}">
		    	<p>科目：${item}(${param.cd})</p><br>
		    	<p>成績情報が存在しませんでした</p>
		    </c:when>
		    <c:when test = "${empty stu_list}">学生情報が存在しませんでした</c:when>
    		<c:otherwise>
